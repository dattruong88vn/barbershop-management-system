...
export function VisitHistorySection({
  ...
  const shouldShowEmpty = !isLoading && !error && completedVisitCount === 0;
  const shouldShowMore = visibleVisitCount < completedVisitCount;
        ...
        <div className="mt-4 divide-y divide-border overflow-hidden rounded-xl border border-border bg-background md:border-0">
          {visibleVisits.map((visit) => (
            ...
            >
              ...
              <span className="hidden rounded-md border border-green-900/40 bg-green-100 px-2 py-0.5 text-xs text-green-900 md:inline-flex">
