...
- **Backend:** Staff personal report, staff management report và branch report đã có API; các report management còn lại giữ placeholder/mock cho đến khi có backend.
