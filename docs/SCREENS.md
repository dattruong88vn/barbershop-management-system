...
- **Backend:** Staff personal report, staff management report, branch report và service/combo report đã có API; các report management còn lại giữ placeholder/mock cho đến khi có backend.
