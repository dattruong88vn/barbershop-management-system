...
- Sửa staff/branch/service/combo/revenue report API, filter, branch scope, allocated revenue hoặc detail pagination: chạy `npm run smoke:reports`.
...
- Staff/branch/service/combo/revenue report API, date range, role/search/status/sort filter, allocated revenue hoặc detail pagination: chạy `npm run smoke:reports`.
