...
- Detail query cache keys include staff id, branch, `fromDate`, `toDate`, page, and page size.
...
- `npm run smoke:reports` covers owner/manager scope, inactive staff visibility, unknown assignment, API role/search filters, invalid date ranges, and detail pagination.
