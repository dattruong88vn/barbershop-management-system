...
- **TanStack Query** — server state management cho Client Components
...
- **Prisma v6** — ORM type-safe, migration có version control

## Auth

- **NextAuth.js + Credentials Provider** — tự quản lý username/password, miễn phí, tích hợp tốt với Next.js + Prisma
- JWT strategy — stateless, scale tốt cho SaaS multi-tenant
